...
- Catapult/STATSports will argue accelerometer-grade load accuracy; our
  answer is the validation ladder in
  [`docs/roadmap_2026-08_mvp.md`](../docs/roadmap_2026-08_mvp.md) — a
  parallel-session MAE table against a vest, which is **planned and not yet
  measured** (there is no end-to-end ground truth today, only reconstruction
  repeatability) — plus the KPIs vests cannot do at all (biomech angles, tactical
