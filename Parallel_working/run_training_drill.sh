...
DRILL="${1:?usage: run_training_drill.sh <drill> [--athlete NAME] [--face-id] [--people N] [--rounds N] [--duration S] [--flip] [--seed N] [--fullscreen]}"
shift
...
echo "[drill] starting drill board: $DRILL"
./venv/bin/python garage_lab_combined/scripts/training_drill.py --drill "$DRILL" "${DRILL_ARGS[@]}"
RC=$?
