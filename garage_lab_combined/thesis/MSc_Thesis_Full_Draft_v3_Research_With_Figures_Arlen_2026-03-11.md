...
![Figure 3.1 - Garage arena reconstruction baseline view](figures_selected/fig_arena360_view_01.png)

### Figure 3.2 - Arena 3D Reconstruction (Orbit View)
![Figure 3.2 - Garage arena reconstruction orbit view](figures_selected/fig_arena360_view_02.png)

### Figure 3.3 - Arena 3D Reconstruction (Extended Orbit View)
![Figure 3.3 - Garage arena reconstruction extended orbit](figures_selected/fig_arena360_view_03.png)
...
![Figure 4.1 - Reprojection overlay camNorth](figures_selected/fig_overlay_camNorth.jpg)

### Figure 4.2 - Calibration Overlay (camEast)
![Figure 4.2 - Reprojection overlay camEast](figures_selected/fig_overlay_camEast.jpg)

### Figure 4.3 - Calibration Overlay (camSouth)
![Figure 4.3 - Reprojection overlay camSouth](figures_selected/fig_overlay_camSouth.jpg)

### Figure 4.4 - Calibration Overlay (camWest)
![Figure 4.4 - Reprojection overlay camWest](figures_selected/fig_overlay_camWest.jpg)
...
![Figure 5.1 - Smoke session reconstructed frame 80](figures_selected/fig_smoke_frame_0080.png)

### Figure 5.2 - Smoke Session Render (frame 200)
![Figure 5.2 - Smoke session reconstructed frame 200](figures_selected/fig_smoke_frame_0200.png)

### Figure 5.3 - Smoke Session Render (frame 320)
![Figure 5.3 - Smoke session reconstructed frame 320](figures_selected/fig_smoke_frame_0320.png)
...
![Figure 7.1 - Ball static raw vs corrected metrics](figures_selected/fig_static_raw_vs_corrected.png)

### Figure 7.2 - Ball Static Axis Bias (Raw)
![Figure 7.2 - Ball static raw axis bias](figures_selected/fig_static_axis_bias_raw.png)

### Figure 7.3 - Ball Dynamic Summary
![Figure 7.3 - Detection ratio and reprojection for slow/fast/no-ball](figures_selected/fig_dynamic_summary.png)

### Figure 7.4 - Intrinsics Reprojection by Camera
![Figure 7.4 - Intrinsics reprojection error per camera](figures_selected/fig_intrinsics_reproj_by_camera.png)

### Figure 7.5 - Extrinsics RMSE by Camera
![Figure 7.5 - Extrinsics reprojection RMSE per camera](figures_selected/fig_extrinsics_rmse_by_camera.png)

### Figure 7.6 - Joint 3D GT vs Estimated Points
![Figure 7.6 - Joint touch 3D GT vs estimated](figures_selected/fig_joint_touch_3d_gt_vs_est.png)

### Figure 7.7 - Joint Error Boxplot
![Figure 7.7 - Joint error distribution](figures_selected/fig_joint_touch_error_boxplot.png)

### Figure 7.8 - Joint Mean Error by Joint Type
![Figure 7.8 - Joint mean error by joint](figures_selected/fig_joint_mean_error_by_joint.png)
