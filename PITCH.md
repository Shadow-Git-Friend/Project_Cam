...
9. **Roadmap & team** — 10-week engineering plan (ROADMAP.md), pilot →
...
GPU supply (mitigate: CPU-fallback profile), license isolation discipline
(mitigated in CI, LICENSE_COMPLIANCE.md), consent for minors (registry
built-in), Astana winters (indoor-first is the design center, not a
